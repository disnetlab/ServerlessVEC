...
##                                position=pos,**kwargs)
        ...
        attached_vm = net.addHost("D"+apname, mac=randomMac, ip = "172.18.5.12/24",cls=Docker, ports=[80,8888], dcmd='./start_cluster.sh', mem_limit="512m",cpu_shares=20, dimage="server_example:latest")
